...
def main():
    selected_columns = ['gameId','gameDuraton', 'blueWins', 'blueFirstBlood', 'blueFirstTower', 'blueFirstBaron', 'blueFirstDragon', 'blueFirstInhibitor', 'blueDragonKills', 
                        'blueBaronKills', 'blueTowerKills', 'blueInhibitorKills', 'blueWardPlaced', 'blueWardkills', 'blueKills', 'blueAssist', 'blueChampionDamageDealt', 
                        'blueChampionDamageDealt', 'blueChampionDamageDealt', 'blueTotalGold', 'blueTotalMinionKills', 'blueTotalLevel', 'blueAvgLevel', 'blueJungleMinionKills', 
    ...
    all_data.to_csv("blue_combined_cleaned_dataset.csv", index=False)
